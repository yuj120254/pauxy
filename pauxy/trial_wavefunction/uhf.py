...
class UHF(object):
    ...
    def __init__(self, system, trial={}, verbose=0):
        ...
        self.restricted_hf = trial.get('restricted_hf', False)
    ...
    def find_uhf_wfn(self, system, ueff, ninit,
        ...
        for attempt in range(0, ninit):
            ...
            for it in range(0, nit_max):
                ...
                if verbose:
                    print("# it %d enew  %f  eold  %f" % (it, enew, eold))
                    #print(niup)
                    #print(nidown)
    ...
    def initialise(self, nbasis, nup, ndown):
        ...
        if (self.restricted_hf):
            (e_down, ev_down) = (e_up, ev_up)
        else:
